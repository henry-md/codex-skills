...
- Intermediate self-evaluations do not require a screenshot if the logged-in DOM or other direct inspection methods can tell you whether you are moving in the right direction.
